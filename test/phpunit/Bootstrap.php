...
namespace CustomerVendorMember\Member\PhpUnit\Test;
 ...
 * Class Bootstrap
 *
 * @package CustomerVendorMember\Member\PhpUnit\Test
 */
class Bootstrap
{
    /**
        ...
        try {
            AutoloaderFactory::factory([
                StandardAutoloader::class => [
                    ...
                    'namespaces' => [
                        'CustomerVendorMember\\Member' => __DIR__ . '/../../src/',
                        __NAMESPACE__ => __DIR__ . '/tests/',
                        'CustomerVendorMember\\Member\\PhpUnit\\TestData' => __DIR__ . '/files'
                    ]
                ]
            ]);
        } catch (\Exception $e) {
